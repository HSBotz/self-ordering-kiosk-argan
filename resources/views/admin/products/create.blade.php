            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="mb-3 form-check">
                        <input type="checkbox" class="form-check-input" id="is_available" name="is_available" value="1" {{ old('is_available', '1') == '1' ? 'checked' : '' }}>
...
<script>
    ...
    editImageBtn.addEventListener('click', function() {
        if (originalFile) {
            ...
            reader.onload = function(e) {
                ...
                // Siapkan filter preview setelah modal ditampilkan
    ...
    cropBtn.addEventListener('click', function() {
        ...
        const croppedFile = new File([blob], createFileName(originalFile.name), { type: 'image/jpeg' });
