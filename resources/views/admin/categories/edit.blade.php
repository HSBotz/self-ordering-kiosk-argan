        ...
        <form action="{{ route('admin.categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" id="has_variants" name="has_variants" value="1" {{ old('has_variants', $category->has_variants) ? 'checked' : '' }}>
                ...
                <div class="tabs-container">
                    ...
                    <div class="tab-content" id="imageTabsContent">
                        <div class="tab-pane fade show active" id="icon-tab-pane" role="tabpanel" aria-labelledby="icon-tab" tabindex="0">
                            ...
                            <input type="hidden" name="icon" id="selected-icon-input" value="{{ $category->icon ?? 'fas fa-coffee' }}">

                            <div class="icon-grid">
                                <!-- Food & Drink Icons -->
                                <div class="icon-item {{ $category->icon == 'fas fa-coffee' ? 'selected' : '' }}" data-icon="fas fa-coffee">
                                    <i class="fas fa-coffee"></i>
                                    <span class="icon-name">Coffee</span>
                                </div>
                                <div class="icon-item {{ $category->icon == 'fas fa-mug-hot' ? 'selected' : '' }}" data-icon="fas fa-mug-hot">
                                    <i class="fas fa-mug-hot"></i>
                                    <span class="icon-name">Hot Drink</span>
                                </div>
                                <div class="icon-item {{ $category->icon == 'fas fa-glass-martini-alt' ? 'selected' : '' }}" data-icon="fas fa-glass-martini-alt">
                                    <i class="fas fa-glass-martini-alt"></i>
                                    <span class="icon-name">Cocktail</span>
                                </div>
                                <div class="icon-item {{ $category->icon == 'fas fa-beer' ? 'selected' : '' }}" data-icon="fas fa-beer">
                                    <i class="fas fa-beer"></i>
                                    <span class="icon-name">Beer</span>
                                </div>
                                <div class="icon-item {{ $category->icon == 'fas fa-wine-glass-alt' ? 'selected' : '' }}" data-icon="fas fa-wine-glass-alt">
                                    <i class="fas fa-wine-glass-alt"></i>
                                    <span class="icon-name">Wine</span>
                                </div>
                                <div class="icon-item {{ $category->icon == 'fas fa-cookie' ? 'selected' : '' }}" data-icon="fas fa-cookie">
                                    <i class="fas fa-cookie"></i>
                                    <span class="icon-name">Cookie</span>
                                </div>
                                <div class="icon-item {{ $category->icon == 'fas fa-ice-cream' ? 'selected' : '' }}" data-icon="fas fa-ice-cream">
                                    <i class="fas fa-ice-cream"></i>
                                    <span class="icon-name">Ice Cream</span>
                                </div>
                                <div class="icon-item {{ $category->icon == 'fas fa-pizza-slice' ? 'selected' : '' }}" data-icon="fas fa-pizza-slice">
                                    <i class="fas fa-pizza-slice"></i>
                                    <span class="icon-name">Pizza</span>
                                </div>
                                <div class="icon-item {{ $category->icon == 'fas fa-hamburger' ? 'selected' : '' }}" data-icon="fas fa-hamburger">
                                    <i class="fas fa-hamburger"></i>
                                    <span class="icon-name">Burger</span>
                                </div>
                                <div class="icon-item {{ $category->icon == 'fas fa-hotdog' ? 'selected' : '' }}" data-icon="fas fa-hotdog">
                                    <i class="fas fa-hotdog"></i>
                                    <span class="icon-name">Hotdog</span>
                                </div>
                                <div class="icon-item {{ $category->icon == 'fas fa-bacon' ? 'selected' : '' }}" data-icon="fas fa-bacon">
                                    <i class="fas fa-bacon"></i>
                                    <span class="icon-name">Bacon</span>
                                </div>
                                <div class="icon-item {{ $category->icon == 'fas fa-drumstick-bite' ? 'selected' : '' }}" data-icon="fas fa-drumstick-bite">
                                    <i class="fas fa-drumstick-bite"></i>
                                    <span class="icon-name">Chicken</span>
                                </div>
                                <div class="icon-item {{ $category->icon == 'fas fa-carrot' ? 'selected' : '' }}" data-icon="fas fa-carrot">
                                    <i class="fas fa-carrot"></i>
                                    <span class="icon-name">Vegetable</span>
                                </div>
                                <div class="icon-item {{ $category->icon == 'fas fa-leaf' ? 'selected' : '' }}" data-icon="fas fa-leaf">
                                    <i class="fas fa-leaf"></i>
                                    <span class="icon-name">Vegan</span>
                                </div>
                                <div class="icon-item {{ $category->icon == 'fas fa-pepper-hot' ? 'selected' : '' }}" data-icon="fas fa-pepper-hot">
                                    <i class="fas fa-pepper-hot"></i>
                                    <span class="icon-name">Spicy</span>
                                </div>
                                <div class="icon-item {{ $category->icon == 'fas fa-egg' ? 'selected' : '' }}" data-icon="fas fa-egg">
                                    <i class="fas fa-egg"></i>
                                    <span class="icon-name">Egg</span>
                                </div>
                                <div class="icon-item {{ $category->icon == 'fas fa-apple-alt' ? 'selected' : '' }}" data-icon="fas fa-apple-alt">
                                    <i class="fas fa-apple-alt"></i>
                                    <span class="icon-name">Fruit</span>
                                </div>
                                <div class="icon-item {{ $category->icon == 'fas fa-cheese' ? 'selected' : '' }}" data-icon="fas fa-cheese">
                                    <i class="fas fa-cheese"></i>
                                    <span class="icon-name">Cheese</span>
                                </div>
                                <div class="icon-item {{ $category->icon == 'fas fa-bread-slice' ? 'selected' : '' }}" data-icon="fas fa-bread-slice">
                                    <i class="fas fa-bread-slice"></i>
                                    <span class="icon-name">Bread</span>
                                </div>
                                <div class="icon-item {{ $category->icon == 'fas fa-utensils' ? 'selected' : '' }}" data-icon="fas fa-utensils">
                                    <i class="fas fa-utensils"></i>
                                    <span class="icon-name">Food</span>
                                </div>
                                <div class="icon-item {{ $category->icon == 'fas fa-birthday-cake' ? 'selected' : '' }}" data-icon="fas fa-birthday-cake">
                                    <i class="fas fa-birthday-cake"></i>
                                    <span class="icon-name">Cake</span>
                                </div>
                                <div class="icon-item {{ $category->icon == 'fas fa-candy-cane' ? 'selected' : '' }}" data-icon="fas fa-candy-cane">
                                    <i class="fas fa-candy-cane"></i>
                                    <span class="icon-name">Candy</span>
                                </div>
                                <div class="icon-item {{ $category->icon == 'fas fa-fish' ? 'selected' : '' }}" data-icon="fas fa-fish">
                                    <i class="fas fa-fish"></i>
                                    <span class="icon-name">Seafood</span>
                                </div>
                                <div class="icon-item {{ $category->icon == 'fas fa-seedling' ? 'selected' : '' }}" data-icon="fas fa-seedling">
                        ...
                        <div class="tab-pane fade" id="upload-tab-pane" role="tabpanel" aria-labelledby="upload-tab" tabindex="0">
                            <div class="image-preview-container">
                                <div class="image-preview" id="image-preview">
                                    @if($category->image)
                                        <img src="{{ asset('storage/'.$category->image) }}" alt="{{ $category->name }}" id="preview">
                                    @else
...
<script>
    ...
    // Cek jika ada gambar yang dipilih saat halaman dimuat
    document.addEventListener('DOMContentLoaded', function() {
        const hasImage = @json(!!$category->image);
        const hasIcon = @json(!!$category->icon);
